var quakequery = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
...
d3.json(quakequery, function(data) {
...
//   Add the layer control to the map
  ...
  d3.json(platequery, function(data) {
    L.geoJson(data, {
      style: function() {
